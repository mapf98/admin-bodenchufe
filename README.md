...
Administrador del E-Commerce BODEnchufe, back-office para administración del E-Commerce.
...
Las siguientes instrucciones servirán para tener un copia funcional del administrador:
...
Y listo, el administrador ya estará disponible para su uso en la URL proporcionada en la terminal 🚀
